...
class RobustNotificationHandler {
      ...
      if (currentStatus == 'accepted' || currentStatus == 'rejected') {
        ...
        if (currentStatus == 'accepted' && action == 'accepted') {
          ...
          if (fromUserId != null && toUserId != null) {
            await MatchChatCreator.createChatOnMutualMatch(
                fromUserId, toUserId);
          }
        }
  ...
  static Future<void> _checkMutualInterestAndCreateChat(
  ...
  static Future<void> _retryRespondNotification(
      String notificationId, String action,
  ...
  static Future<bool> isNotificationAlreadyResponded(
      String notificationId) async {
    try {
      final notificationDoc =
          await _firestore.collection('interests').doc(notificationId).get();
