...
class JavaScriptErrorHandler {
  ...
  static JavaScriptErrorHandler get instance =>
      _instance ??= JavaScriptErrorHandler._();
  ...
  void initialize() {
    ...
    try {
      ...
      EnhancedLogger.success(
          '✅ [ERROR_HANDLER] Sistema inicializado com sucesso para ${Platform.operatingSystem}');
    } catch (e) {
  ...
  void _setupUnhandledRejectionHandler() {
    ...
    EnhancedLogger.info(
        '📱 [ERROR_HANDLER] Sistema de captura configurado para mobile');
  }
  ...
  bool _handlePlatformError(Object error, StackTrace stack) {
    try {
      ...
      EnhancedLogger.error(
          '❌ [ERROR_HANDLER] Erro ao processar erro de plataforma',
          error: e);
      return false;
    }
  }
  ...
  Map<String, dynamic> _extractPlatformErrorInfo(
  ...
  void _attemptRecovery(String errorType, Map<String, dynamic> errorInfo) {
    try {
      ...
      EnhancedLogger.error('❌ [ERROR_HANDLER] Erro na recuperação automática',
          error: e, data: {'errorType': errorType});
    }
  }
  ...
  void _recoverFromFlutterError(Map<String, dynamic> errorInfo) {
    ...
    EnhancedLogger.info(
        '🔄 [ERROR_HANDLER] Tentativa de recuperação de erro Flutter',
        data: errorInfo);
  }
  ...
  void _recoverFromPlatformError(Map<String, dynamic> errorInfo) {
    ...
    EnhancedLogger.info(
        '🔄 [ERROR_HANDLER] Tentativa de recuperação de erro de plataforma',
        data: errorInfo);
  }
  ...
  void _recoverFromNetworkError(Map<String, dynamic> errorInfo) {
    ...
    EnhancedLogger.info(
        '🔄 [ERROR_HANDLER] Tentativa de recuperação de erro de rede',
        data: errorInfo);
  }
  ...
  void _handleNetworkRecovery() {
    EnhancedLogger.warning(
        '🌐 [ERROR_HANDLER] Erro de rede detectado - implementando fallback');
  ...
  void _performRecoveryCheck() {
    try {
      ...
      if (recentErrors.length > 10) {
        EnhancedLogger.warning(
            '⚠️ [ERROR_HANDLER] Muitos erros recentes detectados',
      ...
      EnhancedLogger.error(
          '❌ [ERROR_HANDLER] Erro na verificação de recuperação',
          error: e);
    }
  }
  ...
  void _performEmergencyRecovery() {
    try {
      EnhancedLogger.warning(
          '🚨 [ERROR_HANDLER] Executando recuperação de emergência');
      ...
      EnhancedLogger.error(
          '❌ [ERROR_HANDLER] Erro na recuperação de emergência',
          error: e);
    }
  }
  ...
  void _reloadCriticalResources() {
    try {
      ...
      EnhancedLogger.error('❌ [ERROR_HANDLER] Erro ao recarregar recursos',
          error: e);
    }
  }
  ...
  void _restartCriticalComponents() {
    try {
      ...
      EnhancedLogger.info(
          '🔄 [ERROR_HANDLER] Componentes críticos reiniciados');
    } catch (e) {
      EnhancedLogger.error('❌ [ERROR_HANDLER] Erro ao reiniciar componentes',
          error: e);
    }
  }
