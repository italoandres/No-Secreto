...
class MexicoLocationData implements LocationDataInterface {
  ...
  static const Map<String, List<String>> _statesAndCities = {
    ...
    'México': ['Toluca', 'Ecatepec', 'Nezahualcóyotl', 'Naucalpan', 'Tlalnepantla', 'Texcoco'],
    ...
    'Oaxaca': ['Oaxaca de Juárez', 'Salina Cruz', 'Juchitán', 'Tuxtepec', 'Puerto Escondido'],
    ...
    'Veracruz': ['Veracruz', 'Xalapa', 'Coatzacoalcos', 'Córdoba', 'Poza Rica', 'Orizaba'],
