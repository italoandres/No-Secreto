...
class GermanyLocationData implements LocationDataInterface {
  ...
  static const Map<String, List<String>> _statesAndCities = {
    ...
    'Baviera': ['Munique', 'Nuremberg', 'Augsburgo', 'Regensburgo', 'Ingolstadt', 'Würzburg'],
    'Berlim': ['Berlim'],
    'Brandemburgo': ['Potsdam', 'Cottbus', 'Brandenburg', 'Frankfurt (Oder)'],
    'Bremen': ['Bremen', 'Bremerhaven'],
    'Hamburgo': ['Hamburgo'],
    'Hesse': ['Frankfurt', 'Wiesbaden', 'Kassel', 'Darmstadt', 'Offenbach'],
    'Mecklemburgo-Pomerânia Ocidental': ['Rostock', 'Schwerin', 'Neubrandenburg', 'Stralsund'],
    'Baixa Saxônia': ['Hanôver', 'Braunschweig', 'Osnabrück', 'Oldenburg', 'Göttingen'],
    'Renânia do Norte-Vestfália': ['Colônia', 'Düsseldorf', 'Dortmund', 'Essen', 'Duisburgo', 'Bochum', 'Bonn'],
    'Renânia-Palatinado': ['Mainz', 'Ludwigshafen', 'Koblenz', 'Trier', 'Kaiserslautern'],
