...
class StorieFileModel {
  ...
  static UserSexo? _parsePublicoAlvo(dynamic value) {
    ...
    if (value is String) {
      try {
        ...
        print('DEBUG MODEL: Erro ao converter publicoAlvo "$value" para enum: $e');
        return null;
      }
    }
    
    print('DEBUG MODEL: Tipo não suportado para publicoAlvo: ${value.runtimeType}');
    return null;
  }
  ...
  static StorieFileModel fromJson(Map<String, dynamic> json) {
    ...
    return StorieFileModel(
      ...
      videoDuration: json['videoDuration'] == null ? 0 : int.parse('${json['videoDuration']}'),
