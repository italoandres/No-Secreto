...
class ProfileEngagementModel {
  ...
  int get priority {
    ...
    if (engagementScore > 100) basePriority += 5;
    else if (engagementScore > 50) basePriority += 3;
    else if (engagementScore > 25) basePriority += 2;
    ...
    if (daysSinceLastActivity <= 1) basePriority += 3;
    else if (daysSinceLastActivity <= 7) basePriority += 2;
  ...
  factory ProfileEngagementModel.fromJson(Map<String, dynamic> json) {
    return ProfileEngagementModel(
      ...
      interactionMetrics: Map<String, dynamic>.from(json['interactionMetrics'] ?? {}),
    );
  }
  ...
  ProfileEngagementModel copyWith({
    ...
    return ProfileEngagementModel(
      ...
      hasCompletedSinaisCourse: hasCompletedSinaisCourse ?? this.hasCompletedSinaisCourse,
