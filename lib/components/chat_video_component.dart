...
class ChatVideoComponent extends StatelessWidget {
  ...
  const ChatVideoComponent({super.key, required this.item, required this.showArrow, required this.usuarioModel});
  ...
  Widget build(BuildContext context) {
    ...
    return ContainerChatItemComponent(
      ...
      child: Container(
        ...
        ) : VideoPlayer(url: item.fileUrl!, videoThumbnail: item.videoThumbnail, isLoacal: false, width: w)
      ))
    );
  }
}