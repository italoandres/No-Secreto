...
/// Card com toggle de preferência de virgindade
class VirginityPreferenceToggleCard extends StatelessWidget {
  final bool isEnabled;
  final Function(bool) onToggle;

  const VirginityPreferenceToggleCard({
    Key? key,
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(
                  Icons.favorite,
                  color: isEnabled ? Colors.pink[400] : Colors.grey[400],
                  size: 24,
                ),
              ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              Colors.pink.withOpacity(0.08),
                              Colors.pink[300]!.withOpacity(0.08),
                            ],
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Ative para priorizar perfis com esta preferência de virgindade',
                      style: TextStyle(
                        fontSize: 12,
