...
/// Card com toggle de preferência do movimento Deus é Pai
class DeusEPaiPreferenceToggleCard extends StatelessWidget {
  final bool isEnabled;
  final Function(bool) onToggle;

  const DeusEPaiPreferenceToggleCard({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isEnabled ? Colors.indigo.withOpacity(0.3) : Colors.grey[300]!,
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(
                  Icons.favorite,
                  color: isEnabled ? Colors.indigo[600] : Colors.grey[400],
                  size: 24,
                ),
              ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              Colors.indigo.withOpacity(0.08),
                              Colors.indigo[300]!.withOpacity(0.08),
                            ],
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Ative para priorizar membros do movimento Deus é Pai',
                      style: TextStyle(
                        fontSize: 12,
