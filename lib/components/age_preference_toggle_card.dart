...
/// Card com toggle de preferência de idade
class AgePreferenceToggleCard extends StatelessWidget {
  final bool isEnabled;
  final Function(bool) onToggle;

  const AgePreferenceToggleCard({
    Key? key,
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(
                  Icons.favorite,
                  color: isEnabled ? const Color(0xFF4169E1) : Colors.grey[400],
                  size: 24,
                ),
              ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Ative para priorizar perfis nesta faixa etária',
                      style: TextStyle(
                        fontSize: 12,
