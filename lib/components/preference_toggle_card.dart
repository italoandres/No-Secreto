...
/// Card com toggle de preferência de distância
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Tenho mais interesse em pessoas que correspondam a essa preferência',
                  style: TextStyle(
                    fontSize: 15,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Ative para priorizar perfis dentro da distância',
                      style: TextStyle(
                        fontSize: 12,
