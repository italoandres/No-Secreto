...
class TokenUsuario {
  ...
  set lastTimestempFocused( int value ) => _prefs.setInt('lastTimestempFocused', value);

  UserSexo get sexo => _prefs.getString('sexo') == null ? UserSexo.masculino : UserSexo.values.byName(_prefs.getString('sexo')!);
