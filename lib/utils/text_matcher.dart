...
class TextMatcher {
  ...
  static List<MatchResult> fuzzySearch(
    ...
    for (int i = 0; i < texts.length; i++) {
      final text = texts[i];
      final score =
          calculateMatchScore(text, query, caseSensitive: caseSensitive);
  ...
  static List<String> suggestCorrections(
    ...
    for (final suggestion in suggestions) {
      ...
      uniqueSuggestions[suggestion.suggestion] =
          math.max(current, suggestion.similarity);
    }
...
class Match {
  ...
  bool operator ==(Object other) {
    ...
    return other is Match && other.start == start && other.end == end;
  }
