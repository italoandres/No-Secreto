class StorageProxy {
  static const String _functionUrl =
      'https://us-central1-app-no-secreto-com-o-pai.cloudfunctions.net/getStorageImage';
  ...
  static String getProxiedUrl(String firebaseStorageUrl) {
    try {
      ...
      if (pathSegments.length >= 4 &&
        ...
        final proxiedUrl =
            '$_functionUrl?path=${Uri.encodeComponent(decodedPath)}';
      ...
      print(
          '⚠️ PROXY: URL não reconhecida como Firebase Storage, usando original');
