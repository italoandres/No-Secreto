...
class ContextValidator {
  ...
  static bool validateAndLog(String? contexto, String operation, {bool debugEnabled = true}) {
    ...
    if (debugEnabled) {
      if (isValid) {
        ...
        print('❌ CONTEXT_VALIDATOR: $operation - Contexto inválido: "$contexto" (será normalizado para "${getDefaultContext()}")');
      }
    }
  ...
  static bool validateContextForCollection(String? contexto, String collection) {
    final normalizedContext = normalizeContext(contexto);
