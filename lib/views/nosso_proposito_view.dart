...
class _NossoPropositoViewState extends State<NossoPropositoView> {
  ...
  int totMsgs = 0;
  final Rx<PurposePartnershipModel?> partnership = Rx<PurposePartnershipModel?>(null);
  ...
  Future<void> _loadPartnership() async {
    try {
      ...
      final userPartnership = await PurposePartnershipRepository.getUserPartnership(currentUser.uid)
          ...
          return Scaffold(
            ...
            body: Stack(
              children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  user.isAdmin != true ? const NossoPropositoNotificationComponent() : Container(
                                    width: 50, height: 50,
                    ...
                    Expanded(
                      child: Stack(
                        children: [
                          ...
                          Stack(
                            children: [
                              Obx(() => partnership.value != null && partnership.value!.isActivePartnership
                          ...
                          builder: (context, snapshot) {
                            ...
                            return StreamBuilder<List<StorieFileModel>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return StreamBuilder<List<StorieFileModel>>(
                                  stream: StoriesRepository.getAllByContext('nosso_proposito'),
                                  builder: (context, snapshot) {
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  borderRadius: BorderRadius.circular(Get.width),
                                                  color: listStoriesNaoVisto.isEmpty ? null : const Color(0xFF39b9ff), // Azul por fora
                                                ),
                                                padding: const EdgeInsets.all(3),
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: listStoriesNaoVisto.isEmpty ? Colors.black : const Color(0xFFfc6aeb), // Rosa por dentro
                                                    borderRadius: BorderRadius.circular(Get.width),
                                                  ),
                ...
                Obx(() => partnership.value != null && partnership.value!.isActivePartnership
                    ? Positioned(
                        top: (Get.width * 339 / 1289) + 90, // Abaixo da logo "NOSSO PROPÓSITO"
                        left: 0,
                        right: 0,
                        child: Center(
                          child: Container(
                      ...
                      Obx(() => showMentionAutocomplete.value
                          ? Padding(
                              ...
                              child: MentionAutocompleteComponent(
                                ...
                                onDismiss: () => showMentionAutocomplete.value = false,
                              ),
                            )
                          : const SizedBox()),
                        ...
                        child: Row(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Obx(() => TextField(
                                          ...
                                          enabled: partnership.value != null && partnership.value!.isActivePartnership,
                                          style: TextStyle(
                                            color: partnership.value != null && partnership.value!.isActivePartnership 
                                                ? Colors.black 
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText: partnership.value != null && partnership.value!.isActivePartnership 
                                                ? AppLanguage.lang('digite_aqui')
                                      ...
                                      SizedBox(
                                        ...
                                        child: Obx(() => Container(
                                          decoration: BoxDecoration(
                                            ...
                                            gradient: ChatController.showModalCamera.value == true 
                                          ...
                                          child: TextButton(
                                            ...
                                            child: Icon(
                                              ...
                                              color: ChatController.showModalCamera.value == true 
                                                ? Colors.white 
                                      ...
                                      SizedBox(
                                        ...
                                        child: Obx(() => Container(
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(20),
                                            gradient: ChatController.showModalFiles.value == true 
                                              ? const LinearGradient(
                                                  colors: [
                                                    Color(0xFF38b6ff), // Azul
                                                    Color(0xFFf76cec), // Rosa
                                          ...
                                          child: TextButton(
                                            ...
                                            child: Icon(
                                              Icons.attach_file, 
                                              color: ChatController.showModalFiles.value == true 
                                                ? Colors.white 
                                                : const Color(0xFFf76cec),
                                            ),
                                          ),
                                        )),
                                      ),
                            ...
                            Container(
                              margin: const EdgeInsets.only(left: 16),
                              child: Obx(() => InkWell(
                                onTap: partnership.value != null && partnership.value!.isActivePartnership 
                                    ? () {
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(100),
                                    gradient: partnership.value != null && partnership.value!.isActivePartnership
                                        ? const LinearGradient(
                                            colors: [
                                              Color(0xFF38b6ff), // Azul
                                              Color(0xFFf76cec), // Rosa
                                    ...
                                    boxShadow: partnership.value != null && partnership.value!.isActivePartnership
                                        ? [
                                            BoxShadow(
                                  ...
                                  child: Obx(() => Icon(
                                    partnership.value != null && partnership.value!.isActivePartnership
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.photo_size_select_actual_rounded, color: Colors.white),
                    ),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.video_camera_back_rounded, color: Colors.white),
                    ),
                    const SizedBox(height: 6),
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if(temDistincaoDeSexo.value == true) {
                      await NotificationController.sendNotificationToTopic(titulo: titulo, msg: msg, abrirStories: false, topico: 'sexo_m');
                      await NotificationController.sendNotificationToTopic(titulo: tituloF, msg: msgF, abrirStories: false, topico: 'sexo_f');
                    } else {
                      await NotificationController.sendNotificationToTopic(titulo: titulo, msg: msg, abrirStories: false);
                    }
                  },
  ...
  Widget _buildSharedChat(UsuarioModel user) {
    return StreamBuilder<List<PurposeChatModel>>(
      stream: PurposePartnershipRepository.getSharedChat(partnership.value!.chatId!),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          return const Center(child: CircularProgressIndicator());
        }
          ...
          return Center(
            child: Container(
              ...
              margin: EdgeInsets.only(
                left: 16, right: 16, bottom: 16, top: (Get.width * 339 / 1289) * 0.2
              ),
              decoration: BoxDecoration(
        ...
        for (var data in datas) {
          ...
          for (var chatItem in messages) {
            if (DateFormat('dd/MM/y').format(data) == DateFormat('dd/MM/y').format(chatItem.dataCadastro!.toDate())) {
              ...
              print('🎨 DEBUG OUTROS: autorSexo = "${chatItem.autorSexo}", autorNome = "${chatItem.autorNome}"');
              ...
              if (chatItem.tipo == ChatType.text) {
                ...
                widgets.add(ChatImgComponent(item: chatItem.toChatModel(), usuarioModel: messageUser, showArrow: true));
              } else if (chatItem.tipo == ChatType.video) {
                widgets.add(ChatVideoComponent(item: chatItem.toChatModel(), usuarioModel: messageUser, showArrow: true));
              } else if (['mp3', 'm4a', 'ogg', 'opus'].contains(chatItem.fileExtension)) {
                widgets.add(ChatAudioComponent(item: chatItem.toChatModel(), usuarioModel: messageUser, showArrow: true));
              } else {
                widgets.add(ChatOutroFormatoComponent(item: chatItem.toChatModel(), usuarioModel: messageUser, showArrow: true));
              }
            }
          }
        ...
        return ListView.builder(
          ...
          padding: EdgeInsets.only(
            left: 0, right: 0, bottom: 16 + 60 + MediaQuery.of(context).padding.bottom, 
  ...
  Widget _buildSharedChatTextComponent(PurposeChatModel chatItem, UsuarioModel currentUser) {
    // SEMPRE criar o usuário baseado nos dados da mensagem para garantir cor correta
    // Debug para verificar o valor do autorSexo
    print('🎨 DEBUG SEXO: autorSexo = "${chatItem.autorSexo}", autorNome = "${chatItem.autorNome}"');
  ...
  Future<void> _sendSharedMessage() async {
    ...
    final participantIds = [partnership.value!.user1Id!, partnership.value!.user2Id!];
  ...
  void _onMentionUserSelected(UsuarioModel user) {
    ...
    final afterMention = text.substring(ChatController.msgController.selection.baseOffset);
    ...
    ChatController.msgController.selection = TextSelection.collapsed(offset: newCursorPosition);
    ...
    try {
      ...
      if (users.isNotEmpty) {
        ...
        for (var user in users) {
          if (user.username != null && user.username!.toLowerCase() == name.toLowerCase()) {
            return user.id;
          }
        }
        ...
        for (var user in users) {
          if (user.nome != null && user.nome!.toLowerCase().contains(name.toLowerCase())) {
            return user.id;
          }
        }
      }
  ...
  void _searchUsersForAutocomplete(String username, RxList<UsuarioModel> searchResults, 
                                  RxBool showAutocomplete, UsuarioModel currentUser) async {
    try {
      final users = await PurposePartnershipRepository.searchUsersByName(username);
      
      // Filtrar usuários válidos
      final validUsers = users.where((foundUser) {
        // Não mostrar o próprio usuário
        if (foundUser.id == FirebaseAuth.instance.currentUser?.uid) return false;
  ...
  void _searchUserByUsername(String username, RxString errorMessage, RxBool isValidSearch, 
                            RxBool showUserProfile, Rx<UsuarioModel?> selectedUser, UsuarioModel currentUser) async {
    try {
      final users = await PurposePartnershipRepository.searchUsersByName(username);
      if (users.isNotEmpty) {
  ...
  void _showAddPartnerDialog(UsuarioModel user) {
    ...
    searchController.addListener(() {
      ...
      if (query.isEmpty) {
        ...
        errorMessage.value = '';
        _searchUsersForAutocomplete(query.substring(1), searchResults, showAutocomplete, user);
      }
    });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.info_outline, color: Color(0xFF39b9ff), size: 20),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(8),
                          borderSide: const BorderSide(color: Color(0xFF39b9ff)),
                        ),
                      ),
                    ),
                    const SizedBox(height: 8),
                                ...
                                return ListTile(
                                  leading: CircleAvatar(
                                    backgroundImage: foundUser.imgUrl != null
                                        ...
                                        : null,
                                    backgroundColor: const Color(0xFF39b9ff).withOpacity(0.1),
                                    child: foundUser.imgUrl == null
                                        ? Text(
                                            foundUser.nome?.isNotEmpty == true
                                                ? foundUser.nome![0].toUpperCase()
                                                : '?',
                                  ...
                                  title: Text(
                                    foundUser.username != null && foundUser.username!.isNotEmpty
                                        ? '@${foundUser.username}'
                                  ...
                                  onTap: () {
                                    selectedUser.value = foundUser;
                                    final displayName = foundUser.username != null && foundUser.username!.isNotEmpty
                                        ? '@${foundUser.username}'
                                        : '@${foundUser.nome}';
                    ...
                    Obx(() => showUserProfile.value && selectedUser.value != null
                        ? Container(
                            padding: const EdgeInsets.all(12),
                            decoration: BoxDecoration(
                              color: Colors.grey.shade50,
                              borderRadius: BorderRadius.circular(8),
                              border: Border.all(color: const Color(0xFF39b9ff).withOpacity(0.3)),
                            ),
                            child: Row(
                              children: [
                                // Avatar
                                      ...
                                      ? ClipRRect(
                                          ...
                                          child: Image.network(
                                            ...
                                            errorBuilder: (context, error, stackTrace) {
                                              return Center(
                                                child: Text(
                                                  selectedUser.value!.nome?.isNotEmpty == true 
                                                      ? selectedUser.value!.nome![0].toUpperCase() 
                                                      : '?',
                                                  style: const TextStyle(
                                                    color: Color(0xFF39b9ff),
                                                    fontSize: 16,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        selectedUser.value!.username != null && selectedUser.value!.username!.isNotEmpty
                                            ? '@${selectedUser.value!.username}'
                                            : selectedUser.value!.nome ?? 'Usuário',
                                        style: const TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w600,
                                        ),
                                      ),
                                      if (selectedUser.value!.email != null) ...[
                        ...
                        ? Column(
                            ...
                            children: [
                              ...
                              TextField(
                                ...
                                maxLines: 3,
                                decoration: InputDecoration(
                                  hintText: 'Escreva uma mensagem personalizada para o convite...',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  focusedBorder: OutlineInputBorder(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Obx(() => ElevatedButton(
                            onPressed: isValidSearch.value && selectedUser.value != null
                                ? () {
                            ...
                            child: Text(
                              'Enviar Convite',
                              style: TextStyle(
                                color: isValidSearch.value ? Colors.white : Colors.grey.shade600,
                              ),
                            ),
                          )),
                        ),
  ...
  void _sendPartnerInviteWithMessage(UsuarioModel targetUser, String message, UsuarioModel currentUser) async {
    try {
      // Debug dos IDs
      print('🔍 Debug IDs:');
      ...
      await PurposePartnershipRepository.sendPartnershipInviteWithMessage(
        targetUser.email!, 
        message.isNotEmpty ? message : 'Gostaria de conversar com Deus juntos no Propósito!',
        currentUser
      );
  ...
  void _sendPartnerInvite(String searchTerm, UsuarioModel currentUser) async {
    try {
      ...
      await PurposePartnershipRepository.sendPartnershipInvite(searchTerm, currentUser);
