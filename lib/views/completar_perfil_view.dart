      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                    ...
                    Container(
                      ...
                      child: InkWell(
                        ...
                        child: ClipRRect(
                            borderRadius: BorderRadius.circular(Get.width),
                            child: Obx(() =>
                                CompletarPerfilController.imgPath.value.isEmpty
            ...
            Text('${AppLanguage.lang('ola')}, ${user.nome?.split(' ')[0]}!',
                style:
                    const TextStyle(fontWeight: FontWeight.w500, fontSize: 17)),
            Text(AppLanguage.lang('cadastrar_img_chat'),
              ...
              child: Stack(
                children: [
                  Positioned.fill(
                    ...
                    child: Obx(() =>
                        CompletarPerfilController.imgBgPath.value.isEmpty
                            ? Opacity(
                                opacity: 0.3,
                                child: Image.asset(
            ...
            Column(
              ...
              children: [
                Text('${AppLanguage.lang('sexo_opcional')}:',
                ...
                Container(
                    ...
                    child: Obx(
                      () => DropdownButton<UserSexo>(
                        ...
                        items: UserSexo.values
                            .map<DropdownMenuItem<UserSexo>>((UserSexo value) {
                          return DropdownMenuItem<UserSexo>(
                            value: value,
                            child: Text(value == UserSexo.none
                                ? AppLanguage.lang('n_informar')
