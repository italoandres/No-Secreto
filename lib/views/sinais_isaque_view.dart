                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: const NotificationIconComponent(contexto: 'sinais_isaque'),
                                  ),
                  ...
                  children: [
                    StreamBuilder<List<StorieVistoModel>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        print('🚨 SINAIS ISAQUE: Chamando getAllSinaisIsaque()');
                        return StreamBuilder<List<StorieFileModel>>(
                          stream: StoriesRepository.getAllSinaisIsaque(), // FORÇANDO MÉTODO ESPECÍFICO
                          builder: (context, snapshot) {
                            print('🚨 SINAIS ISAQUE: StreamBuilder executado - hasData: ${snapshot.hasData}');
                            if(snapshot.hasData) {
                                ...
                                child = InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Get.to(() => const EnhancedStoriesViewerView(
                                      ...
                                      userSexo: UserSexo.feminino, // Apenas usuários femininos
                                    ));
                                  },
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      List<StorieFileModel> validStories = listStories.where((story) {
                                        ...
                                        if (story.publicoAlvo != null && story.publicoAlvo != UserSexo.feminino) {
                                          return false;
                                        }
                                      ...
                                      print('DEBUG SINAIS ISAQUE: Stories totais: ${listStories.length}');
                                      print('DEBUG SINAIS ISAQUE: Stories válidos: ${validStories.length}');
                                      print('DEBUG SINAIS ISAQUE: Stories vistos: ${vistosIds.length}');
                                      print('DEBUG SINAIS ISAQUE: Stories não vistos: ${listStoriesNaoVisto.length}');
                                      print('DEBUG SINAIS ISAQUE: Círculo rosa: ${listStoriesNaoVisto.isNotEmpty}');
                                      ...
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          gradient: listStoriesNaoVisto.isEmpty ? null : const LinearGradient(
                                            colors: [
                                              Color(0xFFf76cec), // Rosa para Sinais de Isaque
                                              Color(0xFFf76cec),
                                            ],
                          ...
                          children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          onChanged: (String? text) async {
                                            ...
                                            if(text.split('\n').length > 1) {
                                              ChatController.sendMsgSinaisIsaque(isFirst: totMsgs == 0);
                                              return;
                                            }
                            ...
                            Container(
                              ...
                              child: InkWell(
                                ...
                                child: Material(
                                  color: const Color(0xFFf76cec), // Rosa específico do Sinais Isaque (fundo do botão)
                                  borderRadius: BorderRadius.circular(100),
                                  elevation: 3,
                                  child: SizedBox(
                                    width: 52, height: 52,
                                    child: Obx(() => Icon(
                                      ...
                                      color: Colors.white, // Ícone branco para contrastar com o fundo rosa
                                    )),
                                  ),
                                )
                              ),
