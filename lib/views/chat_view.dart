                                ...
                                child: InkWell(
                                    ...
                                    child: Material(
                                      ...
                                      child: SizedBox(
                                        ...
                                        height: 52,
                                        child: Obx(() => Icon(
                                            ChatController.showBtnAudio.value ==
                                                    false
                                                ? Icons.send
                                                : (AudioController
                                                            .isGravandoAudio
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              icon: Icon(temDistincaoDeIdioma.value == false
                                  ? Icons.check_circle
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              onPressed: () =>
                                  temDistincaoDeIdioma.value = true,
                              label: const Text('Sim'),
                              icon: Icon(temDistincaoDeIdioma.value == true
                                  ? Icons.check_circle
                                  : Icons.circle_outlined),
                            ),
                          )
                ...
                // Seleção de idiomas
                Obx(() => temDistincaoDeIdioma.value == false
                    ? const SizedBox()
                    : Container(
                        margin: const EdgeInsets.only(bottom: 16),
                        ...
                        child: Column(
                          ...
                          children: [
                            const Text('Selecione os idiomas:',
