                              ...
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: const NotificationIconComponent(contexto: 'sinais_rebeca'),
                                  ),
                                      ...
                                      if(DateFormat('dd/MM/y').format(data) == DateFormat('dd/MM/y').format(chatItem.dataCadastro!.toDate())) {
                                        if(chatItem.tipo == ChatType.text) {
                                          widgets.add(ChatTextComponent(
                                            ...
                                            usuarioModel: user, 
                                            showArrow: true,
                                            textColor: chatItem.orginemAdmin == true ? const Color(0xFF38b6ff) : Colors.white,
                                          ));
                  ...
                  children: [
                    StreamBuilder<List<StorieVistoModel>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        print('🚨 SINAIS REBECA: Chamando getAllSinaisRebeca()');
                        return StreamBuilder<List<StorieFileModel>>(
                          stream: StoriesRepository.getAllSinaisRebeca(), // FORÇANDO MÉTODO ESPECÍFICO
                          builder: (context, snapshot) {
                            print('🚨 SINAIS REBECA: StreamBuilder executado - hasData: ${snapshot.hasData}');
                            if(snapshot.hasData) {
                                ...
                                child = InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Get.to(() => const EnhancedStoriesViewerView(
                                      ...
                                      userSexo: UserSexo.masculino, // Apenas usuários masculinos
                                    ));
                                  },
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      List<StorieFileModel> validStories = listStories.where((story) {
                                        ...
                                        if (story.publicoAlvo != null && story.publicoAlvo != UserSexo.masculino) {
                                          return false;
                                        }
                                      ...
                                      print('DEBUG SINAIS REBECA: Stories totais: ${listStories.length}');
                                      print('DEBUG SINAIS REBECA: Stories válidos: ${validStories.length}');
                                      print('DEBUG SINAIS REBECA: Stories vistos: ${vistosIds.length}');
                                      print('DEBUG SINAIS REBECA: Stories não vistos: ${listStoriesNaoVisto.length}');
                                      print('DEBUG SINAIS REBECA: Círculo azul: ${listStoriesNaoVisto.isNotEmpty}');
                                      ...
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          gradient: listStoriesNaoVisto.isEmpty ? null : const LinearGradient(
                                            colors: [
                                              Color(0xFF38b6ff), // Azul para Sinais de Rebeca
                                              Color(0xFF38b6ff),
                                            ],
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          onChanged: (String? text) async {
                                            ...
                                            if(text.split('\n').length > 1) {
                                              _sendMsgSinaisRebeca(isFirst: totMsgs == 0);
                                              return;
                                            }
                                      ...
                                      SizedBox(
                                        ...
                                        child: Obx(() => TextButton(
                                          style: TextButton.styleFrom(
                                            ...
                                            backgroundColor: ChatController.showModalCamera.value == true ? const Color(0xFF38b6ff).withOpacity(0.1) : Colors.transparent
                                          ),
                                          onPressed: () {
                                      ...
                                      SizedBox(
                                        ...
                                        child: Obx(() => TextButton(
                                          style: TextButton.styleFrom(
                                            ...
                                            backgroundColor: ChatController.showModalFiles.value == true ? const Color(0xFF38b6ff).withOpacity(0.1) : Colors.transparent
                                          ),
                                          onPressed: () {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Obx(() => InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: ChatController.group.value == grupo.en ? const Color(0xFF38b6ff).withOpacity(0.1) : Colors.transparent,
                        borderRadius: BorderRadius.circular(8)
                      ),
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                      child: grupo.imgAssets == null ? Text(grupo.pt!) : Image.asset(grupo.imgAssets!, width: 24, height: 24),
                    ),
                  ));
                }
              ),
            ...
            Expanded(
              child: FutureBuilder<List<EmojiModel>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<EmojiModel> emojis = snapshot.data!.where((element) => element.group == ChatController.group.value).toList();
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.photo_size_select_actual_rounded, color: Color(0xFF38b6ff)),
                    ),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.camera_alt, color: Color(0xFF38b6ff)),
                    ),
                    const SizedBox(height: 6),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.insert_drive_file_rounded, color: Color(0xFF38b6ff)),
                    ),
                    const SizedBox(height: 6),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      width: 55, height: 45,
                      child: const Icon(Icons.video_camera_back_rounded, color: Color(0xFF38b6ff)),
                    ),
                    const SizedBox(height: 6),
